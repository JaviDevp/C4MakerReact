...
export const ExternalPersonNode = ({ id, data, selected }) => {
	const [formValues, handleInputChange] = useForm({
		title: data.title !== undefined ? data.title : 'External Person Name',
		category: data.category !== undefined ? data.category : '[Person]',
		description:
	...
	const targetStyle = { background: '#ffffff', border: '1px solid #000000' };
	...
	return (
		<div
			...
			<div className='bg-gray-400 border border-black	 rounded-full h-24 w-24 flex justify-center	translate-y-2'></div>

			<div className='bg-gray-400 border border-black	 flex flex-col p-2 rounded-full'>
