...
export const PersonNode = ({ id, data, selected }) => {
	const [formValues, handleInputChange] = useForm({
		...
		description:
			data.description !== undefined ? data.description : 'Descripción',
	});
	...
	return (
		<div
			...
			<div className='bg-blue-800 border border-black	 rounded-full h-24 w-24 flex justify-center	translate-y-2'></div>
