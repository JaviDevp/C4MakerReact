	...
	return (
		<div className='ml-1 mt-1'>
			<div className='flex flex-col my-3 mx-1'>
				...
				<button
					className='border-solid border rounded-md border-gray-500 my-3 hover:bg-slate-300'
			...
			<div className='mx-1'>
				<CopyToClipboard
					text={`Enlace de invitación para el proyecto: https://c4maker.herokuapp.com/diagram/${params.id}`}>
					<button
						className='my-4 py-2 px-3 bg-green-600 border border-gray-500 rounded-md text-white font-bold
                         hover:bg-green-700 hover:text-white'
						onClick={() =>
							toast('invitación copiada al portapapeles', {
								style: {
									borderRadius: '10px',
									background: '#333',
									color: '#fff',
