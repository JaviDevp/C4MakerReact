...
export const ToolBar = () => {
	...
	return (
		<aside>
			...
			<div
				onDragStart={event => onDragStart(event, 'SoftwareSystem')}
				draggable>
			...
			<div
				onDragStart={event => onDragStart(event, 'ExternalPerson')}
				draggable>
			...
			<div
				onDragStart={event => onDragStart(event, 'ExternalSoftwareSystem')}
				draggable>
				<NodeToolBar
					path='/assets/ExternalSoftwareSystem.jpg'
